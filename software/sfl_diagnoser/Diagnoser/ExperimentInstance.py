...
class Instances_Management:
    ...
    def __init__(self):
        if not Instances_Management.instance:
            Instances_Management.instance = Instances_Management.__Instances_Management()
